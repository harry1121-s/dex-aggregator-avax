...
export class PangolinExchange extends ethereum.SmartContract {
  static bind(address: Address): PangolinExchange {
    return new PangolinExchange("PangolinExchange", address);
  }
